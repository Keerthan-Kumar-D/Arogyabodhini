...
export const DOCTOR_ACCOUNTS = [
  {
    id: 'doc-priya-sharma',
    email: 'priya.sharma@arogyabodhini.com',
    password: 'Doctor@123',
    name: 'Dr. Priya Sharma',
    spec: 'Cardiologist',
    regNo: 'MCI-KA-2013-45672',
  ...
  {
    id: 'doc-rajesh-kumar',
    email: 'rajesh.kumar@arogyabodhini.com',
    password: 'Doctor@123',
    name: 'Dr. Rajesh Kumar',
    spec: 'Neurologist',
    regNo: 'MCI-TN-2011-38821',
  ...
  {
    id: 'doc-ananya-reddy',
    email: 'ananya.reddy@arogyabodhini.com',
    password: 'Doctor@123',
    name: 'Dr. Ananya Reddy',
    spec: 'General Physician',
    regNo: 'MCI-AP-2016-22109',
  ...
  {
    id: 'doc-meena-iyer',
    email: 'meena.iyer@arogyabodhini.com',
    password: 'Doctor@123',
    name: 'Dr. Meena Iyer',
    spec: 'General Physician',
    regNo: 'MCI-TN-2014-19876',
  ...
  {
    id: 'doc-suresh-nair',
    email: 'suresh.nair@arogyabodhini.com',
    password: 'Doctor@123',
    name: 'Dr. Suresh Nair',
    spec: 'Dermatologist',
    regNo: 'MCI-KA-2013-51234',
...
/**
 * getDemoCredentials — returns first account for demo purposes
 */
